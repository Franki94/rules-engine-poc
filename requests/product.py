class Invoice:
    ...
    # Documents: property(get_age,set_age,del_age)
...
class ProductActions(BaseActions):
    ...
    @rule_action(params={"sale_percentage": 'numeric'})
    ...
    @rule_action(params={"sale_percentage": 'numeric'})
    def put_on_sale22(self, sale_percentage):
        self.product.price = (1.0 - sale_percentage) * self.product.price
        print(self.product.price)
        # self.product.save()
        

class InvoiceActions(BaseActions):
    def __init__(self, invoice):
        self.invoice = invoice

    @rule_action(params={"small_message": 'text'})
    def print_message(self, small_message):
        print(small_message)
    
    @rule_action(params={"small_message": 'text'})
    def print_message2(self, small_message):
        print(small_message)
